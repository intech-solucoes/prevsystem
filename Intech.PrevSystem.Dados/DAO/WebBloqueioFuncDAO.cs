...
{   
    public abstract class WebBloqueioFuncDAO : BaseDAO<WebBloqueioFuncEntidade>
    {
		...
		public virtual IEnumerable<WebBloqueioFuncEntidade> BuscarJoinPlanoEmpresaEntidade()
		{
			try
			{
