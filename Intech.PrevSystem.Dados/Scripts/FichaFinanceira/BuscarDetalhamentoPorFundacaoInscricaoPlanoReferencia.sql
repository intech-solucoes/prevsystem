...
SELECT FF.CD_FUNDACAO,
       ...
       FF.CD_OPERACAO,
       ISNULL(FF.CONTRIB_PARTICIPANTE,0) AS CONTRIB_PARTICIPANTE,
       ISNULL(FF.CONTRIB_EMPRESA,0) AS CONTRIB_EMPRESA,
       ISNULL(FF.QTD_COTA_RP_PARTICIPANTE, 0) AS QTD_COTA_RP_PARTICIPANTE,
       ISNULL(FF.QTD_COTA_RP_EMPRESA, 0) AS QTD_COTA_RP_EMPRESA,
