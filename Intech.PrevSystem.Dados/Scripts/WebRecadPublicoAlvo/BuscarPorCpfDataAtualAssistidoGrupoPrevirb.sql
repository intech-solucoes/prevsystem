...
SELECT
	...
	CASE
		   ...
		   WHEN SP.CD_CATEGORIA = '4' AND SP.CD_SIT_PLANO IN ('22', '40', '42', '51', '58') THEN 'PENSIONISTA'
	   ...
	   CASE
		   ...
		   WHEN SP.CD_CATEGORIA = '4' AND SP.CD_SIT_PLANO IN ('22', '40', '42', '51', '58') THEN 2
...
WHERE EE.CPF_CGC = @CPF
  AND PA.NUM_INSCRICAO = @NUM_INSCRICAO
