    ...
    public class RelacionamentoController : Controller
    {
        ...
        public IActionResult Post([FromBody]RelacionamentoEntidade relacionamentoEntidade)
        {
            try
            {
                ...
                EnvioEmail.Enviar(
                    emailConfig, 
                    emailConfig.EmailRelacionamento, 
                    $"Sabesprev Mobile - {relacionamentoEntidade.Assunto}", 
                    $"Mensagem de <b>{relacionamentoEntidade.Email}</b>:<br/><br/>{relacionamentoEntidade.Mensagem}");
