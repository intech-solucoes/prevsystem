...
SELECT TB_TIPO_CONTRIBUICAO.DS_TIPO_CONTRIBUICAO,
       ...
       TB_TIPO_CONTRIBUICAO.COMPOE_SALDO_BENEFICIO,
       CC_FICHA_FINANCEIRA.* 
...
AND CC_FICHA_FINANCEIRA.ANO_REF = (SELECT MAX(FF1.ANO_REF)
				                    ...
				                    WHERE FF1.CD_FUNDACAO = CC_FICHA_FINANCEIRA.CD_FUNDACAO
				                    AND FF1.CD_PLANO = CC_FICHA_FINANCEIRA.CD_PLANO
				                    AND FF1.NUM_INSCRICAO = CC_FICHA_FINANCEIRA.NUM_INSCRICAO)
