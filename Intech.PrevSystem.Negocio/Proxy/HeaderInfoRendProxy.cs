...
namespace Intech.PrevSystem.Negocio.Proxy
{
    public class HeaderInfoRendProxy : HeaderInfoRendDAO
    {
        ...
        public HeaderInfoRendEntidade BuscarPorMatriculaReferencia(string matricula, decimal referencia)
        {
            var informe = BuscarPorMatriculaAnoCalendario(matricula, referencia).First();
            informe.Grupos = new List<InfoRendGrupoEntidade>();
