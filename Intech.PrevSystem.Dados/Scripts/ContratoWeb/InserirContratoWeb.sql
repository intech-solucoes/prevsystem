...
VALUES (@CD_FUNDACAO,
        ...
        @VL_DEBITOS,
        @VL_PREST_ATRASO_CONCESSAO,
        @VL_PREST_MES_CONCESSAO,
        @VL_PRINC_PREST_ATRASO,
        @VL_CORR_PREST_ATRASO,
        @OBSERVACAO,
        @VL_RESIDUO_AMORTIZACAO,
        @CD_SIT_FUNDACAO,
        @VL_TX_INVALIDEZ,
        @COD_CONVENIO,
        @CD_FORMA_PAGTO,
