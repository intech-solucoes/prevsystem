...
namespace Intech.PrevSystem.Dados.DAO
{
	public abstract class DadosPessoaisDAO : BaseDAO<DadosPessoaisEntidade>
	{
		...
		public virtual DadosPessoaisEntidade BuscarPorCodEntid(string COD_ENTID)
		{
			...
			{
				if (AppSettings.IS_SQL_SERVER_PROVIDER)
					return Conexao.QuerySingleOrDefault<DadosPessoaisEntidade>("SELECT     CS_DADOS_PESSOAIS.*,     EE_ENTIDADE.CPF_CGC,     EE_ENTIDADE.NOME_ENTID FROM CS_DADOS_PESSOAIS INNER JOIN EE_ENTIDADE ON EE_ENTIDADE.COD_ENTID = CS_DADOS_PESSOAIS.COD_ENTID WHERE CS_DADOS_PESSOAIS.COD_ENTID = @COD_ENTID", new { COD_ENTID }, Transaction);
				else if (AppSettings.IS_ORACLE_PROVIDER)
					return Conexao.QuerySingleOrDefault<DadosPessoaisEntidade>("SELECT CS_DADOS_PESSOAIS.*, EE_ENTIDADE.CPF_CGC, EE_ENTIDADE.NOME_ENTID FROM CS_DADOS_PESSOAIS INNER  JOIN EE_ENTIDADE  ON EE_ENTIDADE.COD_ENTID=CS_DADOS_PESSOAIS.COD_ENTID WHERE CS_DADOS_PESSOAIS.COD_ENTID=:COD_ENTID", new { COD_ENTID }, Transaction);
				else
					throw new Exception("Provider não suportado!");
		...
		public virtual void Insert(decimal COD_ENTID, string CD_NACIONALIDADE, string CD_GRAU_INSTRUCAO, string CD_ESTADO_CIVIL, string SEXO, string NATURALIDADE, string UF_NATURALIDADE, DateTime DT_NASCIMENTO, string NU_IDENT, string ORG_EMIS_IDENT, DateTime? DT_EMIS_IDENT, string NU_CTPS, string SERIE_CTPS, string UF_EMIS_CTPS, string COD_BANCO_COB, string COD_AGENC_COB, string CD_TIPO_COB, string NUM_CONTA_COB, string NOME_PAI, string NOME_MAE, string CD_PAIS, string NR_DEP_COB, decimal? QTD_DEPENDENTE, string CD_EMP_COB, string PS_DOENCA_CRONICA, string EMAIL_AUX, string FONE_CELULAR, DateTime? DT_FALECIMENTO, string ENVIAR_CARTAO, string CARTAO_ENVIADO, decimal? NUMERO_CARTAO, string SEGUNDA_VIA_CARTAO, string CARTAO_CANCELADO, string ALTERAR_DADOS_PORT, string CANCELAR_LIM_PORT, string SEGUNDA_VIA_SENHA, string SEGUNDA_VIA_EXTRATO, string CD_CANCELAMENTO_CARTAO, string LIBERAR_CARTAO, string INTERDICAO, string CNT_ABERT_CRED, decimal? COD_ENTID_CURADOR, string NOME_CONJUGE, string CPF_CONJUGE, string TEMPO_MILITAR, string END_CORREIO, string UF_EMIS_IDENT, string CD_OPERADORA, string APOSENTADO_INSS, string DIR_DOCUMENTOS, decimal? VL_MARGEM_CONSIG, string REG_ESTRANGEIRO, string PAIS_ORIGEM_PASSAPORTE, DateTime? DT_CHEGADA, string NOME_SOCIAL, string IND_RECEBER_EMAIL, string ID_EMP_ONLINE)
		{
			try
			{
				if (AppSettings.IS_SQL_SERVER_PROVIDER)
					Conexao.Execute("INSERT INTO CS_DADOS_PESSOAIS (      COD_ENTID     ,CD_NACIONALIDADE     ,CD_GRAU_INSTRUCAO     ,CD_ESTADO_CIVIL     ,SEXO     ,NATURALIDADE     ,UF_NATURALIDADE     ,DT_NASCIMENTO     ,NU_IDENT     ,ORG_EMIS_IDENT     ,DT_EMIS_IDENT     ,NU_CTPS     ,SERIE_CTPS     ,UF_EMIS_CTPS     ,COD_BANCO_COB     ,COD_AGENC_COB     ,CD_TIPO_COB     ,NUM_CONTA_COB     ,NOME_PAI     ,NOME_MAE     ,CD_PAIS     ,NR_DEP_COB     ,QTD_DEPENDENTE     ,CD_EMP_COB     ,PS_DOENCA_CRONICA     ,EMAIL_AUX     ,FONE_CELULAR     ,DT_FALECIMENTO     ,ENVIAR_CARTAO     ,CARTAO_ENVIADO     ,NUMERO_CARTAO     ,SEGUNDA_VIA_CARTAO     ,CARTAO_CANCELADO     ,ALTERAR_DADOS_PORT     ,CANCELAR_LIM_PORT     ,SEGUNDA_VIA_SENHA     ,SEGUNDA_VIA_EXTRATO     ,CD_CANCELAMENTO_CARTAO     ,LIBERAR_CARTAO     ,INTERDICAO     ,CNT_ABERT_CRED     ,COD_ENTID_CURADOR     ,NOME_CONJUGE     ,CPF_CONJUGE     ,TEMPO_MILITAR     ,END_CORREIO     ,UF_EMIS_IDENT     ,CD_OPERADORA     ,APOSENTADO_INSS     ,DIR_DOCUMENTOS     ,VL_MARGEM_CONSIG     ,REG_ESTRANGEIRO     ,PAIS_ORIGEM_PASSAPORTE     ,DT_CHEGADA     ,NOME_SOCIAL     ,IND_RECEBER_EMAIL     ,ID_EMP_ONLINE ) VALUES (      @COD_ENTID     ,@CD_NACIONALIDADE     ,@CD_GRAU_INSTRUCAO     ,@CD_ESTADO_CIVIL     ,@SEXO     ,@NATURALIDADE     ,@UF_NATURALIDADE     ,@DT_NASCIMENTO     ,@NU_IDENT     ,@ORG_EMIS_IDENT     ,@DT_EMIS_IDENT     ,@NU_CTPS     ,@SERIE_CTPS     ,@UF_EMIS_CTPS     ,@COD_BANCO_COB     ,@COD_AGENC_COB     ,@CD_TIPO_COB     ,@NUM_CONTA_COB     ,@NOME_PAI     ,@NOME_MAE     ,@CD_PAIS     ,@NR_DEP_COB     ,@QTD_DEPENDENTE     ,@CD_EMP_COB     ,@PS_DOENCA_CRONICA     ,@EMAIL_AUX     ,@FONE_CELULAR     ,@DT_FALECIMENTO     ,@ENVIAR_CARTAO     ,@CARTAO_ENVIADO     ,@NUMERO_CARTAO     ,@SEGUNDA_VIA_CARTAO     ,@CARTAO_CANCELADO     ,@ALTERAR_DADOS_PORT     ,@CANCELAR_LIM_PORT     ,@SEGUNDA_VIA_SENHA     ,@SEGUNDA_VIA_EXTRATO     ,@CD_CANCELAMENTO_CARTAO     ,@LIBERAR_CARTAO     ,@INTERDICAO     ,@CNT_ABERT_CRED     ,@COD_ENTID_CURADOR     ,@NOME_CONJUGE     ,@CPF_CONJUGE     ,@TEMPO_MILITAR     ,@END_CORREIO     ,@UF_EMIS_IDENT     ,@CD_OPERADORA     ,@APOSENTADO_INSS     ,@DIR_DOCUMENTOS     ,@VL_MARGEM_CONSIG     ,@REG_ESTRANGEIRO     ,@PAIS_ORIGEM_PASSAPORTE     ,@DT_CHEGADA     ,@NOME_SOCIAL     ,@IND_RECEBER_EMAIL     ,@ID_EMP_ONLINE )", new { COD_ENTID, CD_NACIONALIDADE, CD_GRAU_INSTRUCAO, CD_ESTADO_CIVIL, SEXO, NATURALIDADE, UF_NATURALIDADE, DT_NASCIMENTO, NU_IDENT, ORG_EMIS_IDENT, DT_EMIS_IDENT, NU_CTPS, SERIE_CTPS, UF_EMIS_CTPS, COD_BANCO_COB, COD_AGENC_COB, CD_TIPO_COB, NUM_CONTA_COB, NOME_PAI, NOME_MAE, CD_PAIS, NR_DEP_COB, QTD_DEPENDENTE, CD_EMP_COB, PS_DOENCA_CRONICA, EMAIL_AUX, FONE_CELULAR, DT_FALECIMENTO, ENVIAR_CARTAO, CARTAO_ENVIADO, NUMERO_CARTAO, SEGUNDA_VIA_CARTAO, CARTAO_CANCELADO, ALTERAR_DADOS_PORT, CANCELAR_LIM_PORT, SEGUNDA_VIA_SENHA, SEGUNDA_VIA_EXTRATO, CD_CANCELAMENTO_CARTAO, LIBERAR_CARTAO, INTERDICAO, CNT_ABERT_CRED, COD_ENTID_CURADOR, NOME_CONJUGE, CPF_CONJUGE, TEMPO_MILITAR, END_CORREIO, UF_EMIS_IDENT, CD_OPERADORA, APOSENTADO_INSS, DIR_DOCUMENTOS, VL_MARGEM_CONSIG, REG_ESTRANGEIRO, PAIS_ORIGEM_PASSAPORTE, DT_CHEGADA, NOME_SOCIAL, IND_RECEBER_EMAIL, ID_EMP_ONLINE }, Transaction);
				else if (AppSettings.IS_ORACLE_PROVIDER)
					Conexao.Execute("INSERT INTO CS_DADOS_PESSOAIS (COD_ENTID, CD_NACIONALIDADE, CD_GRAU_INSTRUCAO, CD_ESTADO_CIVIL, SEXO, NATURALIDADE, UF_NATURALIDADE, DT_NASCIMENTO, NU_IDENT, ORG_EMIS_IDENT, DT_EMIS_IDENT, NU_CTPS, SERIE_CTPS, UF_EMIS_CTPS, COD_BANCO_COB, COD_AGENC_COB, CD_TIPO_COB, NUM_CONTA_COB, NOME_PAI, NOME_MAE, CD_PAIS, NR_DEP_COB, QTD_DEPENDENTE, CD_EMP_COB, PS_DOENCA_CRONICA, EMAIL_AUX, FONE_CELULAR, DT_FALECIMENTO, ENVIAR_CARTAO, CARTAO_ENVIADO, NUMERO_CARTAO, SEGUNDA_VIA_CARTAO, CARTAO_CANCELADO, ALTERAR_DADOS_PORT, CANCELAR_LIM_PORT, SEGUNDA_VIA_SENHA, SEGUNDA_VIA_EXTRATO, CD_CANCELAMENTO_CARTAO, LIBERAR_CARTAO, INTERDICAO, CNT_ABERT_CRED, COD_ENTID_CURADOR, NOME_CONJUGE, CPF_CONJUGE, TEMPO_MILITAR, END_CORREIO, UF_EMIS_IDENT, CD_OPERADORA, APOSENTADO_INSS, DIR_DOCUMENTOS, VL_MARGEM_CONSIG, REG_ESTRANGEIRO, PAIS_ORIGEM_PASSAPORTE, DT_CHEGADA, NOME_SOCIAL, IND_RECEBER_EMAIL, ID_EMP_ONLINE) VALUES (:COD_ENTID, :CD_NACIONALIDADE, :CD_GRAU_INSTRUCAO, :CD_ESTADO_CIVIL, :SEXO, :NATURALIDADE, :UF_NATURALIDADE, :DT_NASCIMENTO, :NU_IDENT, :ORG_EMIS_IDENT, :DT_EMIS_IDENT, :NU_CTPS, :SERIE_CTPS, :UF_EMIS_CTPS, :COD_BANCO_COB, :COD_AGENC_COB, :CD_TIPO_COB, :NUM_CONTA_COB, :NOME_PAI, :NOME_MAE, :CD_PAIS, :NR_DEP_COB, :QTD_DEPENDENTE, :CD_EMP_COB, :PS_DOENCA_CRONICA, :EMAIL_AUX, :FONE_CELULAR, :DT_FALECIMENTO, :ENVIAR_CARTAO, :CARTAO_ENVIADO, :NUMERO_CARTAO, :SEGUNDA_VIA_CARTAO, :CARTAO_CANCELADO, :ALTERAR_DADOS_PORT, :CANCELAR_LIM_PORT, :SEGUNDA_VIA_SENHA, :SEGUNDA_VIA_EXTRATO, :CD_CANCELAMENTO_CARTAO, :LIBERAR_CARTAO, :INTERDICAO, :CNT_ABERT_CRED, :COD_ENTID_CURADOR, :NOME_CONJUGE, :CPF_CONJUGE, :TEMPO_MILITAR, :END_CORREIO, :UF_EMIS_IDENT, :CD_OPERADORA, :APOSENTADO_INSS, :DIR_DOCUMENTOS, :VL_MARGEM_CONSIG, :REG_ESTRANGEIRO, :PAIS_ORIGEM_PASSAPORTE, :DT_CHEGADA, :NOME_SOCIAL, :IND_RECEBER_EMAIL, :ID_EMP_ONLINE)", new { COD_ENTID, CD_NACIONALIDADE, CD_GRAU_INSTRUCAO, CD_ESTADO_CIVIL, SEXO, NATURALIDADE, UF_NATURALIDADE, DT_NASCIMENTO, NU_IDENT, ORG_EMIS_IDENT, DT_EMIS_IDENT, NU_CTPS, SERIE_CTPS, UF_EMIS_CTPS, COD_BANCO_COB, COD_AGENC_COB, CD_TIPO_COB, NUM_CONTA_COB, NOME_PAI, NOME_MAE, CD_PAIS, NR_DEP_COB, QTD_DEPENDENTE, CD_EMP_COB, PS_DOENCA_CRONICA, EMAIL_AUX, FONE_CELULAR, DT_FALECIMENTO, ENVIAR_CARTAO, CARTAO_ENVIADO, NUMERO_CARTAO, SEGUNDA_VIA_CARTAO, CARTAO_CANCELADO, ALTERAR_DADOS_PORT, CANCELAR_LIM_PORT, SEGUNDA_VIA_SENHA, SEGUNDA_VIA_EXTRATO, CD_CANCELAMENTO_CARTAO, LIBERAR_CARTAO, INTERDICAO, CNT_ABERT_CRED, COD_ENTID_CURADOR, NOME_CONJUGE, CPF_CONJUGE, TEMPO_MILITAR, END_CORREIO, UF_EMIS_IDENT, CD_OPERADORA, APOSENTADO_INSS, DIR_DOCUMENTOS, VL_MARGEM_CONSIG, REG_ESTRANGEIRO, PAIS_ORIGEM_PASSAPORTE, DT_CHEGADA, NOME_SOCIAL, IND_RECEBER_EMAIL, ID_EMP_ONLINE }, Transaction);
				else
					throw new Exception("Provider não suportado!");
