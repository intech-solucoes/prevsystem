...
namespace Intech.PrevSystem.Dados.DAO
{
	public abstract class ProcessoBeneficioDAO : BaseDAO<ProcessoBeneficioEntidade>
	{
		...
		public virtual List<dynamic> Sabesprev_BuscarExtratoAssistidoPorFundacaoEmpresaPlanoEspecieNumeroProcessoAnoProcessoIncidLiquidoSuplemantacao(string CD_FUNDACAO, string CD_EMPRESA, string CD_PLANO, string CD_ESPECIE, decimal NUM_PROCESSO, string ANO_PROCESSO, string INCID_LIQUIDO, string ID_RUB_SUPLEMENTACAO)
		{
			try
			{
				if (AppSettings.IS_SQL_SERVER_PROVIDER)
