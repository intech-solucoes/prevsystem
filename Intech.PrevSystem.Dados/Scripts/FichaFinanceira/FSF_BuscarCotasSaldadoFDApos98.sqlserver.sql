...
SELECT SUM(CASE 
              WHEN FF.CD_OPERACAO = 'C' THEN FF.QTD_COTA_FD_PARTICIPANTE * PR.VLR_PERC_PARTICIPANTE / 100
              WHEN FF.CD_OPERACAO = 'D' THEN FF.QTD_COTA_FD_PARTICIPANTE * PR.VLR_PERC_PARTICIPANTE / -100
           END) AS QTD_COTA_FD
