...
namespace Intech.PrevSystem.Metrus.Negocio
{
    public class ContratoDisponivel
    {
        ...
        /// 
        /// </summary>
        public List<TaxasEncargosEntidade> taxaEncargo { get; set; }
        ...
        /// 
        /// </summary>
        public List<TaxasConcessaoEntidade> taxaConcessao { get; set; }
        ...
        public List<ContratoDisponivel> BuscarContratosDisponiveis(FuncionarioEntidade funcionario, ConcessaoEntidade concessao, string codPlano, decimal codModalidade, decimal codNatureza, DateTime dataCredito, decimal valorSolicitado, decimal mesesDeCarencia, decimal quantidadeParcelas = 0)
        {
            ...
            foreach (var PrazoDisponivel in Prazos)
            {
                ...
                if (encargo.TP_COBRANCA_TX == "P" && encargo.TP_COBRANCA_INAD == "P" && encargo.TP_COBRANCA_SEGURO == "P" && encargo.TIPO_CALC_ADM == "P")
                {
                    ...
                    ValorPrestacao += (valorPrestacaoAux * (encargo.TX_ADM / 100)).Value.Arredonda(2);

                    ValorSeguro = (valorPrestacaoAux * (encargo.TX_SEGURO / 100)).Value.Arredonda(2);
        ...
        public decimal ObterValorAtualizacao(FuncionarioEntidade funcionario,
                                             ModalidadeEntidade modalidade, NaturezaEntidade natureza, TaxasEncargosEntidade txEncargo,
                                             TaxasConcessaoEntidade txConcessao, decimal ValorSolicitado,
                                             DateTime dtCredito)
        {
        ...
        public decimal CalculaValorIof(NaturezaEntidade natureza,
            TaxasEncargosEntidade taxaEncargo,
        ...
        public decimal CalculaValorAdministracao(TaxasEncargosEntidade encargo, decimal ValorSolicitado, decimal ValorReformado, decimal Prazo)
        {
            decimal calculado = 0;
        ...
        public decimal CalculaValorSeguro(FuncionarioEntidade funcionario, TaxasEncargosEntidade encargo, decimal valorSolicitado, decimal somaReformados)
        {
            decimal calculado = 0;
        ...
        public decimal CalculaValorInadimplencia(TaxasEncargosEntidade encargo, decimal ValorSolicitado, decimal SomaReformados, decimal Prazo)
        {
            decimal calculado = 0;
        ...
        public decimal ObtemUmaPrestacao(decimal valorSolicitado, decimal prazo, TaxasConcessaoEntidade taxaConcessao, TaxasEncargosEntidade taxaEncargo)
        {
