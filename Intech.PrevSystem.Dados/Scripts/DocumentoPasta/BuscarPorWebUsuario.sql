...
SELECT WDP.OID_DOCUMENTO_PASTA, WDP.OID_DOCUMENTO_PASTA_PAI, WDP.NOM_PASTA, WDP.OID_GRUPO_USUARIO
 FROM WEB_DOCUMENTO_PASTA WDP
 LEFT JOIN WEB_USUARIO_GRUPO WUG
 ON WDP.OID_GRUPO_USUARIO = WUG.OID_GRUPO_USUARIO
