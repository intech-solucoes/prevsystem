		...
		public virtual long Insert( decimal OID_RECAD_DADOS,  string TXT_TITULO,  string TXT_NOME_FISICO)
		{
			try
			{
				if(AppSettings.IS_SQL_SERVER_PROVIDER)
					...
					return Conexao.QuerySingleOrDefault<long>("INSERT INTO WEB_RECAD_DOCUMENTO (OID_RECAD_DOCUMENTO,OID_RECAD_DADOS, TXT_TITULO, TXT_NOME_FISICO) VALUES (S_WEB_RECAD_DOCUMENTO.NEXTVAL,:OID_RECAD_DADOS, :TXT_TITULO, :TXT_NOME_FISICO)", new { OID_RECAD_DADOS, TXT_TITULO, TXT_NOME_FISICO });
				else
